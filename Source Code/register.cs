    ...
    public partial class register : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (RegistrationState.LastRegistrationTime.HasValue &&
                DateTime.Now.Subtract(RegistrationState.LastRegistrationTime.Value).TotalMinutes < 1)
            {
                MessageBox.Show("Please a minute before trying to register again.", "Registration Throttled", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            if (!isLengthValid || !hasUpperCase || !hasLowerCase || !hasDigit || isCommonPassword)
            {
                MessageBox.Show("Your password is considered weak. It must be at least 6 characters long, include uppercase and lowercase letters, and a digit.", "Weak Password", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            if (connectionStatus == 0)
            {
                ...
                string hashedPassword = EncryptAndHashString(password); // Hash the password
                ...
                using (var connection = new MySqlConnection(connectionString))
                {
                    ...
                    catch
                    {
                        ...
                        MessageBox.Show("There was a problem when creating your account. Please try again later");
                    }
                }
            }
            else
